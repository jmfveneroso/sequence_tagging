...
A different application of \textit{Information Extraction} is extracting scientific 
valuable information from medical texts such as the interaction between human genes
and proteins. This task 

The field of bio-informatics has also found an application for 
\textit{Information Extraction} in determining gene and protein 
relationships by extracting these entities from paper repositories
such as PubMed [22, 32, 166].

Another scientific application of \textit{Information Extraction} is important 
for citation 
databases such as Citeseer [126], Google Scholar and Cora [144], DBLP and Arxiv.
...
websites. This application is especially important for the evaluation and 
...
indices of academic impact such as such as the H-index (citation) and 
P-score (citation). This application does not involve only Informa

Sarawagi~\cite{Sarawagi2008} gives a far more detailed description of the applications of 
\textit{Information Extraction} in her survey.

\textit{Web Data Extraction} is different from \textit{Information Extraction} from
...
is a multifaceted problem that spans communities of researchers in the fields of Text Mining, 
...
MUC-6  MUC-7~\cite{Chinchor1998}, the CoNLL-2003~\cite{KimSang2003}

or authors and citations from scientific
articles.
