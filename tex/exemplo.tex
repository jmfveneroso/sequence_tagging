...
the model features. Table~\ref{fig:hmm_no_features} shows 

\begin{figure}[h!]
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        title={Hidden Markov Models without Features},
        % ylabel={Value},
        xmin=0, xmax=5,
        ymin=0, ymax=1,
        xtick={0,5},
      ...
      \addplot[ybar, fill=blue, fill opacity=0.3,] coordinates {
        (1,0.181)(2,0.637)(3,0.653)(4,0.551)
      };
      \addplot[ybar, fill=red, fill opacity=0.3,] coordinates {
        (1,0.776)(2,0.458)(3,0.527)(4,0.468)
      };
      \addplot[ybar, fill=green, fill opacity=0.3,] coordinates {
...
HMMs
How does feature selection impact the HMM performance?

How does HMM size impact performance?

How does the self-training strategy impact performance?


CRF
How does feature selection impact the Linear Chain CRF performance?

How do word embeddings affect CRF performance?


Neural Networks

How does the CRF layer impact performance? LSTM-CRF

How do the CRF layer impact performance? LSTM-CRF

How do word embeddings impact performance?

What attention is better?

How the training time increases as we add complexity?
